...
Finished: I set up package using code in `integrateItDevelopmentFile.R`.
...
**PURPOSE**: Documentation/Checklist.

  * I will use this file as a checklist, though no actual work in R will be accomplished here.


**Step 1**: Install `devtools` and create an S4 R Package named `integrateIt`.

  * Use `integrateItDevelopmentFile.R` to set up directory and the package skeleton.

  * **FINISHED**! I have loaded `devtools` and created the "bones" of the package `integrateIt`.


**Step 2**: Create example data and documentation.
